...
In class, we use the above examples at approximately 80% completion. The projects above are fully complete, but in class we use these projects with 20% of the work unfinished to introduce core concepts in small doses within context. [This link](https://github.com/retrobuiltRyan/SMD_Slides/blob/main/PCB%20Teaching%20examples%20BACKUP.zip) contains projects 1-4 as partially incomplete examples with a "to-do" list embedded in each design document.  The layout scope expands with each near-complete project. The linked examples represent fully completed projects and are not reflective of the work explicitly covered in class with the instructor.
